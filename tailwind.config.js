...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Primary brand colors (Modified to purple theme)
        primary: {
          50: "#faf5ff",
          100: "#f3e8ff",
          200: "#e9d5ff",
          300: "#d8b4fe",
          400: "#c084fc",
          500: "#a855f7", // Changed from blue to purple
          600: "#9333ea",
          700: "#7c3aed",
          800: "#6b21a8",
          900: "#581c87",
      ...
      // custom screens
      screens: {
        xxs: "320px", // Very small phones (iPhone SE, older Androids)
        xs: "400px", // Standard mobile width (iPhone X, etc.)
        sm: "640px", // Small (small tablets)
        md: "768px", // Medium (tablets)
        lg: "1024px", // Large (laptops)
        xl: "1280px", // Extra large (desktops)
        "2xl": "1536px", // 2x extra large
        "3xl": "1920px", // 3x extra large (large monitors)
      },
